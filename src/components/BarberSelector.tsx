      ...
      <div className="flex items-center gap-4">
        {barber.photo ? (
          <img
            ...
            alt={barber.name}
            className={cn(
              "w-16 h-16 sm:w-20 sm:h-20 rounded-full object-cover border-2 transition-colors",
              isSelected ? "border-primary" : "border-border"
            )}
          />
        ) : (
          <div className={cn(
            "w-16 h-16 sm:w-20 sm:h-20 rounded-full flex items-center justify-center border-2 transition-colors",
